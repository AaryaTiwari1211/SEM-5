...
def user_input_key(tha_key):  # input the key from the console
    # tha_key = rand_key(64)
    print('64-bit key: ', tha_key)
...
def user_input_plaintext():  # input plaintext in console
    try:
        someIn = str(input('Enter plaintext: '))
    except:
        someIn = str(input('Invalid!! Try again: '))
    return someIn
...
def tha_main(key):  # the main function that processes user inputs
    key = str(key)
    set_key(key)
    ...
    if (first_choice == '0'):
        ...
        print("Cipher text generated is: ", encrypt(plaintext))
        print("\n\n")
    elif (first_choice == '2'):
        ciphertext = str(user_input_ciphertext())
        print("Cipher text is: ", ciphertext)
        print("Plain text generated is: ", decrypt(ciphertext))
        print("\n\n")
